...
const width = '100%';
const height = '100%';
const center = [37.6415198888855, 55.63803916618793] as LngLat;
const zoom = 17;
  ...
  >
    ...
    >
      ...
      <div v-if="openMarker === index" class="popup">
        <div @click.stop="openMarker = null" class="popup__close">
          <SvgClose />
        </div>

        <!--  -->
        <div class="popup__addres">
          115477, г. Москва, ул. Кантемировская, дом 61, 2 этаж, помещение 1 - склад<br /><br />115477,
          г. Москва, ул. Кантемировская, дом 61, 6 этаж - офис
        </div>

        <!--  -->
        <div class="popup__properties">
          <div>
            <div class="popup__properties_title">Телефон:</div>
            <a class="popup__properties_val" rel="nofollow" href="tel:+74993437340">
              +7 (499) 343-73-40
            </a>
          </div>

          <div>
            <div class="popup__properties_title">Почта:</div>
            <a class="popup__properties_val" href="mailto:sale@uzcotton.ru">sale@uzcotton.ru</a>
          </div>
        </div>
      </div>
    </yandex-map-marker>
